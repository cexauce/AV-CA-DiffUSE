...
class Specs(Dataset):
    ...
    def __getitem__(self, i):
        ...
        if self.vfeat_processing_order == "default": 
            ...
            if not self.audio_only and self.video_feature_type == "cogenav":
                #print("Resampling ... v ", v.shape) # [1, T=51, 88, 88] 
                v = torch.unsqueeze(my_resample(torch.squeeze(v), 750), 0) # to have the same nb of frames as the audio
                #print("Ressampled v ", v.shape) # [1, T=750, 88, 88] 
